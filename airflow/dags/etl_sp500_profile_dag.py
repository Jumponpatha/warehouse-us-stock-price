...
from utils.extract_fyahoo_api import extract_sp500_profile
...
def etl_pipeline_dag():
    @task
    def extract_sp500_data_task():
        ''' Extract S&P 500 profile data '''
    ...
    def load_dividend_data_task(df):
        ...
        table_name = "finance_stock_sp500_profile"
    ...
    extract_data = extract_sp500_data_task()
